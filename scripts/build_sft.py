...
Usage::
    ...
    python scripts/build_sft.py \\
        --source smolagents/ml-automation-agent-sessions \\
        --target smolagents/ml-automation-agent-sft \\
        --days 7
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--source", default="smolagents/ml-automation-agent-sessions")
    ap.add_argument("--target", default="smolagents/ml-automation-agent-sft")
    ap.add_argument(
        "--days",
        type=int,
        default=1,
