#!/usr/bin/env python3
"""Backstop sweeper for orphan ml-automation-agent sandbox Spaces.
...
A Space is considered an orphan ml-automation-agent sandbox iff ALL hold:
...
def is_sandbox_fork(space) -> bool:
    """Filter: matches the ml-automation-agent sandbox naming pattern.
