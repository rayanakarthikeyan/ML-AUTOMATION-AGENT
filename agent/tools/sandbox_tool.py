...
SANDBOX_CREATE_TOOL_SPEC = {
    ...
    "description": (
        ...
        "pass `trackio_space_id` (e.g. '<username>/ml-automation-agent-<8char>') and `trackio_project` so they "
        ...
        "properties": {
            ...
            "trackio_space_id": {
                ...
                "description": (
                    ...
                    "(e.g. '<username>/ml-automation-agent-<8char>', under YOUR HF namespace). Injected as "
