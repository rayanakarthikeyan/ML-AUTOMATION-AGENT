...
export default function WelcomeScreen() {
  ...
  // Space URL for iframe "Open ML Automation Agent" step
  const spaceHost =
    typeof window !== 'undefined'
      ? window.location.hostname.includes('.hf.space')
        ? window.location.origin
        : 'https://smolagents-ml-automation-agent.hf.space'
      : '';
      ...
      >
        ...
        >
          {isDevUser ? (
            ...
            <ChecklistStep
              stepNumber={1}
              title="Open ML Automation Agent"
              description="Open the agent in a full browser tab to get started."
              status="active"
              actionLabel="Open ML Automation Agent"
