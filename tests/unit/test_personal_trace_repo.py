...
def _session(*, user_id: str | None, hf_username: str | None) -> Session:
    config = SimpleNamespace(
        ...
        save_sessions=True,
        share_traces=True,
        personal_trace_repo_template="{hf_user}/ml-automation-agent-sessions",
        session_dataset_repo="smolagents/ml-automation-agent-sessions",
...
def test_personal_trace_repo_uses_hf_username_before_oauth_subject():
    ...
    assert session._personal_trace_repo_id() == "lewtun/ml-automation-agent-sessions"
